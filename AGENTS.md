...
| Shared logic | `src/lib/` | Auth, validation, Morpho, wallet links |
...
3. **Crypto:** group on-chain assets by **wallet** (`metadata.walletId`).
...
- Plan / wallets: `src/components/plan/WalletMapGuide.tsx`, `src/lib/wallet-section-links.ts`
